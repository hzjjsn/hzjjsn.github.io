...
function makeCube(){
	...
	var vcol4 = vec4.fromValues( 1.0, 1.0, 0.0, 1.0 );
	var vcol5 = vec4.fromValues( 1.0, 0.0, 1.0, 1.0 );
	var vcol6 = vec4.fromValues( 1.0, 1.0, 1.0, 1.0 );
	var vcol7 = vec4.fromValues( 1.0, 1.0, 0.1, 0.0 );
	var vcol8 = vec4.fromValues( 0.5, 1.0, 0.0, -1.0 );
